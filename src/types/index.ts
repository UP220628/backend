...
export interface Notification {
  ...
  userId: number;
  unitId: number;
  type: 'UNIT_REPORTED' | 'UNIT_RELEASED' | 'UNIT_DELIVERED' | 'WTY_PENDING' | 'WTY_RELEASED' | 'UNIT_WWS_RELEASED' | 'UNIT_ACCEPTED' | 'UNIT_REJECTED' | 'UNIT_RETURNED_TO_SENT' | 'UNIT_ARCHIVED' | 'UNIT_DELETION_REQUESTED' | 'UNIT_DELETION_APPROVED' | 'UNIT_DELETION_REJECTED' | 'STATUS_CHANGED' | 'DEFECT_ADDED' | 'REPAIR_ESTIMATED';
  message: string | null;
  isRead: boolean;
  createdAt: Date;
}
